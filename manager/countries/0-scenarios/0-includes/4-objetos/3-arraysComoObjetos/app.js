...
console.writeln(`¿Está el país de nombre ${country.name}?: ${COUNTRIES.includes(country)}`);
country = {
  name : `Atlantida`
};
console.writeln(`¿Está el país de nombre ${country.name}?: ${COUNTRIES.includes(country)}`);
...
console.writeln(`¿Está el país de nombre ${country.name}?: ${getCountries().includes(country)}`);
