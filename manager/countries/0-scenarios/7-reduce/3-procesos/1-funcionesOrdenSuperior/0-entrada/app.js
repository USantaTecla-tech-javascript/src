...
console.writeln(`¿Cuál es la población total?: ${reduce(getCountries(), getSumPopulation, 0)}`);
console.writeln(`¿Cuál es la lista de "alpha2code"?: ${reduce(getCountries(), getAlpha2CodeList, `Alpha2Codes: `)}`);
console.writeln(`¿Cuál es el área del mayor país?: ${reduce(getCountries(), getMaxArea, 0)}`);
