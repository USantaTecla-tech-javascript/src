...
writelnNames(`¿Cuál es el nombre de los paises de ${region} con población superior o igual a ${population}?:);`,
  filterByRegionPopulation(getCountries(), region, population));
...
writelnNames(`¿Cuál es el nombre de los paises de ${subregion} con area superior o igual a ${area}?:);`,
  filterBySubregionArea(getCountries(), subregion, area));
...
function filterByRegionPopulation(countries, region, population) {
  let result = [];
...
function filterBySubregionArea(countries, subregion, area) {
  let result = [];
  for (let i = 0; i < countries.length; i++) {
