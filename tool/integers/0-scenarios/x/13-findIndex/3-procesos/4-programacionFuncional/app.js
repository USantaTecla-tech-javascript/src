...
// let position = findIndex(getCountries(), ({ region, population }) => region === `Asia` && population > 1000000);
// console.writeln(`¿Cuál es la posición del primer país de ${region} con población superior o igual a ${population}?: ${position}`);

// region = `Americas`;
// population = 1000;
// country = findIndex(getCountries(), ({ region, population }) => region === `Americas` && population > 1000);
// console.writeln(`¿Cuál es la posición del primer país de ${region} con población superior o igual a ${population}?: ${position}`);

// let subregion = `Northern Europe`;
// let area = 100000;
// country = findIndex(getCountries(), ({ subregion, area }) => subregion === `Northern Europe` && area > 100000);
// console.writeln(`¿Cuál es la posición del primer país de ${subregion} con area superior o igual a ${area}?: ${position}`);

// subregion = `Polynesia`;
// area = 1000000;
// country = findIndex(getCountries(), ({ subregion, area }) => subregion === `Polynesia` && area > 1000000);
// console.writeln(`¿Cuál es la posición del primer país de ${subregion} con area superior o igual a ${area}?: ${position}`);

function findIndex([head, ...tail], search) {
  return head === undefined ?
    ...
    search(head) ?
      0
      :
      findIndex(tail, search) === -1 ?
        -1
        :
        1 + findIndex(tail, search)
    ;
}

let value = 3;
console.writeln(`Posición de ${value}: ${findIndex([1,2,3], (number) => number === value)}`);
console.writeln(`Posición de ${value}: ${findIndex([3,2,1], (number) => number === value)}`);
console.writeln(`Posición de ${value}: ${findIndex([3], (number) => number === value)}`);
console.writeln(`Posición de ${value}: ${findIndex([1,2,1], (number) => number === value)}`);
console.writeln(`Posición de ${value}: ${findIndex([], (number) => number === value)}`);
