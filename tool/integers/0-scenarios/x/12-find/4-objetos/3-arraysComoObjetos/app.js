...
let area = 100000;
name = country !== undefined ? country.name : "No existe";
country = getCountries().find((country) => country.subregion === subregion && country.area >= area);
name = country !== undefined ? country.name : "No existe";
console.writeln(`¿Cuál es el nombre del primer país de ${subregion} con área superior o igual a ${area}?: ${name}`);
