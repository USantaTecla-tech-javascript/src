...
let posotion = getCountries().findIndex((country) => country.region === region && country.population >= population);
console.writeln(`¿Cuál es el nombre del primer país de ${region} con población superior o igual a ${population}?: ${posotion}`);

region = `Americas`;
population = 100000;
posotion = getCountries().findIndex((country) => country.region === region && country.population >= population);
console.writeln(`¿Cuál es el nombre del primer país de ${region} con población superior o igual a ${population}?: ${posotion}`);

let subregion = `Northern Europe`;
let area = 100000;
posotion = getCountries().findIndex((country) => country.subregion === subregion && country.area >= area);
console.writeln(`¿Cuál es el nombre del primer país de ${subregion} con área superior o igual a ${area}?: ${posotion}`);
