...
let index = findIndex(getCountries(), (countrie) => countrie.region === region && countrie.population > population);
console.writeln(`¿Cuál es la posición del primer país de ${region} con población superior o igual a ${population}?: ${index}`);

region = `Americas`;
population = 1000;
index = findIndex(getCountries(), (countrie) => countrie.region === region && countrie.population > population);
console.writeln(`¿Cuál es la posición del primer país de ${region} con población superior o igual a ${population}?: ${index}`);

let subregion = `Northern Europe`;
let area = 100000;
index = findIndex(getCountries(), (countrie) => countrie.subregion === subregion && countrie.area > area);
