...
function searchByAsia1000000Population({region, population}){
  return region === `Asia` && population > 1000000;
}

function searchByAmericas1000Population({region, population}){
